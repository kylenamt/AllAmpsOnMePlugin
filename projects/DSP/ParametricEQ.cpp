...
std::array<float, DSP::Biquad::CoeffsPerSection> ParametricEqualizer::calculateCoeffs(const Band& band)
{
    // Flat coeffs
    std::array<float, DSP::Biquad::CoeffsPerSection> coeffs { 1.f, 0.f, 0.f, 0.f, 0.f };
